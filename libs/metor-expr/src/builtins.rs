...
pub fn builtins() -> &'static [Builtin] {
    ...
    const B: &[Builtin] = &[
        ...
        Builtin { name: "clamp", params: &["x", "lo", "hi"], ret: "number", avail: Anywhere, doc: "x limited to [lo, hi]" },
        Builtin { name: "sign", params: &["x"], ret: "number", avail: Anywhere, doc: "-1, 0, or 1 by the argument's sign" },
        ...
        Builtin { name: "hypot", params: &["x", "y"], ret: "f64", avail: Anywhere, doc: "the length of (x, y)" },
        Builtin { name: "lerp", params: &["a", "b", "t"], ret: "f64", avail: Anywhere, doc: "a at t = 0, b at t = 1, linear between" },
        Builtin { name: "atan2", params: &["y", "x"], ret: "f64", avail: Anywhere, doc: "the angle of (x, y), quadrant-correct" },
        Builtin { name: "degrees", params: &["x"], ret: "f64", avail: Anywhere, doc: "radians to degrees" },
        Builtin { name: "radians", params: &["x"], ret: "f64", avail: Anywhere, doc: "degrees to radians" },
        ...
        Builtin { name: "log2", params: &["x"], ret: "f64", avail: Anywhere, doc: "base-2 logarithm" },
        Builtin { name: "log10", params: &["x"], ret: "f64", avail: Anywhere, doc: "base-10 logarithm" },
        ...
        Builtin { name: "mean", params: &["t"], ret: "f64", avail: Anywhere, doc: "the average of a tensor's elements" },
