...
use metor_proto::types::{LenPacket, Msg};
use metor_proto_bbq::*;
use metor_proto_wkt::{NewConnection, StreamId};
    ...
    I: Iterator<Item = LenPacket>,
{
    ...
    let len_pkt = LenPacket::new(metor_proto::types::PacketTy::Msg, NewConnection::ID, 0);
