    ...
    + Immutable
{
    ...
    /// Complete fixed-field layout and direct dynamic bounds for a peer ICD.
    /// Generated by `derive(Frame)`. Hand-written implementations must opt in;
    /// a vtable alone does not describe padding, alignment, or dynamic bounds.
    fn peer_layout() -> Option<crate::peer::FrameLayout> {
        None
    }
}
